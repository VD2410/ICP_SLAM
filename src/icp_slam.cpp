                               ...
                               int iteration)
{
  ...
  cv::Mat tmp;
  cv::flip(img, tmp, 0);
  file_path="./img"+std::to_string(iteration)+".png";
  cout<<file_path<<endl;
                                              ...
                                              const tf::Transform &T_2_1)
{
  ...
  for (int iter=0;iter<max_iterations;iter++)
  {
    ...
    cout<<"ICP before iteration: (%f, %f), %f",last_x,last_y, last_rotation;
    ...
    cout<<"ICP after iteration: (%f, %f), %f",current_x,current_y, current_rotation;
